...
import (
	...
	appparams "github.com/fadeev/venus/app/params"
	"github.com/fadeev/venus/x/venus"
	venuskeeper "github.com/fadeev/venus/x/venus/keeper"
	venustypes "github.com/fadeev/venus/x/venus/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/venusd")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	venusKeeper venuskeeper.Keeper
...
func New(
	...
	app.venusKeeper = *venuskeeper.NewKeeper(
        appCodec, keys[venustypes.StoreKey], keys[venustypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		venus.NewAppModule(appCodec, app.venusKeeper),
